...
GLfloat text_der = 1.0;
GLfloat text_izq = 0.0;

void CFiguras::skybox(GLuint text, GLuint text1, GLuint text2, GLuint text3, GLuint text4, GLuint text5)  
{
	float largo = 40;
	float altura = 25;
	float profundidad = 40;
	GLfloat vertice [8][3] = {
